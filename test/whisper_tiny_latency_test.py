...
# CPU only: re-confirmed at the time this test was added that loading
# tiny.en with device="cuda" raises "This CTranslate2 package was not
# compiled with CUDA support" - same PyPI aarch64 limitation as the base
# model test (see config/specs.md, STT section). Still requires a
# from-source ctranslate2 build (deferred) to get real GPU numbers.
DEVICE = "cpu"
COMPUTE_TYPE = "int8"
...
def main():
    print("Butter Whisper (tiny.en) latency + accuracy test")
